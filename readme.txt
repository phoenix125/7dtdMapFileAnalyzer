...
----- FEATURES -----
- Creates a summary file with number of popular POIs for all yoru Generated Worlds.
- Automatically imports World Gen Name, Seed Name, Map Size, and POI info.
- Fully customizable POI type and search parameters.
- Scans GeneratedWorlds folder recursively.
- Creates a summary .csv file of all your worlds
- Creates a separate text file with detailed POI info for each world.

----- INSTRUCTIONS -----
- Run 7dtdMapFileAnalyzer.exe

- To Import data from your GeneratedWorlds FOLDER:
...
- Added: Option to open output CSV file when complete.
